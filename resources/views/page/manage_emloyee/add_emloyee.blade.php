            ...
            <div class="row mb-2">
                <div class="col-sm-12 text-right">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('page-emloyee') }}">Nhân viên</a></li>
                ...
                <section class="col-lg-6 connectedSortable">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-2">
                            <form action="{{ url('post-page-add-emloyee') }}" id="AddAdmin" method="POST" enctype="multipart/form-data">
                                @csrf
