                ...
                <section class="col-lg-12 connectedSortable">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-1">
                            ...
                            @php($two = DB::table('project_level_twos')->where('id',$three->project_two_id)->first())
                            @php($one = DB::table('project_level_ones')->where('id',$two->project_one_id)->first())
                            @php($parent = DB::table('project_parents')->where('id',$one->project_parent_id)->first())
