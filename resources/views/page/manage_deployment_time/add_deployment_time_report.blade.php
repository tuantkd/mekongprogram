                ...
                <div class="col-sm-12 text-right">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ url('page-month-project-report/'.$add_deployment_time_report->id) }}">
                                Tháng báo cáo
                            </a>
                        </li>
                        ...
                        <div class="card-header">
                            <h3 class="card-title">
                                <b>
                                    ...
                                    THÊM BÁO CÁO
                                    <b class="text-info">{{ $add_deployment_time_report->deployment_month_initialize }}/{{ $add_deployment_time_report->deployment_year_initialize }}</b>
                                </b>
                            </h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body p-2">
                            <form action="{{ url('update-deployment-time-report/'.$add_deployment_time_report->id) }}" id="EditDeployment" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-lg-9">
                                        <textarea name="inputIndexAchieved" rows="3"
                                                  class="form-control" placeholder="Nhập chỉ số đạt được"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-lg-9">
                                        <textarea name="inputResultAchieved" rows="3"
                                                  class="form-control" placeholder="Nhập kết quả đạt được"></textarea>
                                    </div>
                                </div>
